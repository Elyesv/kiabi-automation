"""
Script d'automatisation de la mise à jour du fichier SUIVI_PRODUIT uniquement.
"""
import sys
import re
import shutil
...
from config import ONEDRIVE_BASE_PATH, SUIVI_PRODUIT_CONFIG
...
def main():
    print("=" * 60)
    print("   MISE A JOUR - SUIVI_PRODUIT")
    ...
    try:
        ...
        print("\n" + "=" * 60)
        print(f"   SUIVI_PRODUIT: OK - {new_name}")
        print("=" * 60)
