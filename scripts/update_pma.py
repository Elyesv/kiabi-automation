"""
Script d'automatisation de la mise à jour du fichier SUIVI_PMA uniquement.
"""
import sys
import re
import shutil
...
from config import ONEDRIVE_BASE_PATH, SUIVI_PMA_CONFIG
